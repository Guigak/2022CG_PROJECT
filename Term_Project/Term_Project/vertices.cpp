...
#define LINE_Y_MIDDLE 0.0625
#define LINE_Y_TUM 0.0625
#define LINE_Z 40.0

#define NOTE_X_TUM 0.25
#define NOTE_Y_MIDDLE 0.125
#define NOTE_Y_TUM 0.125
#define NOTE_Z_MIDDLE -0.125
#define NOTE_Z_TUM 0.2
...
GLfloat line_v[16][3] = {
	...
	{ -LINE_X_MIDDLE + LINE_X_TUM,	LINE_Y_MIDDLE + LINE_Y_TUM,	0.0 },
	{ -LINE_X_MIDDLE + LINE_X_TUM,	LINE_Y_MIDDLE - LINE_Y_TUM,	-LINE_Z },
	{ -LINE_X_MIDDLE + LINE_X_TUM,	LINE_Y_MIDDLE + LINE_Y_TUM,	-LINE_Z },
	{ -LINE_X_MIDDLE,	LINE_Y_MIDDLE - LINE_Y_TUM,	-LINE_Z },
	{ -LINE_X_MIDDLE,	LINE_Y_MIDDLE + LINE_Y_TUM,	-LINE_Z },
...
GLfloat trigger_v[8][3] = {
	...
	{ LINE_X_MIDDLE, LINE_Y_MIDDLE - LINE_Y_TUM, TRUGGER_Z },
	{ LINE_X_MIDDLE, LINE_Y_MIDDLE, TRUGGER_Z },
	{ LINE_X_MIDDLE, LINE_Y_MIDDLE - LINE_Y_TUM, -LINE_Y_TUM * 4.0 },
	{ LINE_X_MIDDLE, LINE_Y_MIDDLE, -LINE_Y_TUM * 4.0 },
	{ -LINE_X_MIDDLE, LINE_Y_MIDDLE - LINE_Y_TUM, -LINE_Y_TUM * 4.0 },
	{ -LINE_X_MIDDLE, LINE_Y_MIDDLE, -LINE_Y_TUM * 4.0 }
};
...
// note //
GLfloat note_v[8][3] = {
	{ -NOTE_X_TUM, NOTE_Y_MIDDLE + NOTE_Y_TUM, NOTE_Z_MIDDLE + NOTE_Z_TUM },
	{ -NOTE_X_TUM, NOTE_Y_MIDDLE - NOTE_Y_TUM, NOTE_Z_MIDDLE + NOTE_Z_TUM },
	{ NOTE_X_TUM, NOTE_Y_MIDDLE - NOTE_Y_TUM, NOTE_Z_MIDDLE + NOTE_Z_TUM },
	{ NOTE_X_TUM, NOTE_Y_MIDDLE + NOTE_Y_TUM, NOTE_Z_MIDDLE + NOTE_Z_TUM },
	{ NOTE_X_TUM, NOTE_Y_MIDDLE - NOTE_Y_TUM, NOTE_Z_MIDDLE - NOTE_Z_TUM },
